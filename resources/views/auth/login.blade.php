...
<head>
    ...
    <style>
        ...
        h2.active {
            color: #0d0d0d;
            border-bottom: 2px solid #510616;
        }
...
<body>
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            <h1 class="fadeIn first logo me-auto">
                <a href="/" class="align-items-center d-flex flex-column gap-3 justify-content-center mb-3 mt-5">
                    <img src="{{ asset('public/images/logo.png') }}" class="w-25">
                    <span>مجلة الحكمة</span>
                </a>
            </h1>
            ...
            <form method="POST" action="{{ route('login') }}">
                @csrf
                {{-- Email --}}
                <input type="email" class="fadeIn second" name="email" value="{{ old('email') }}"
                    placeholder="الإيميل" required>

                {{-- Password --}}
                <input type="password" class="fadeIn third" name="password" placeholder="الباسويرد" required>
